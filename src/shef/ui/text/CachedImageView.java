...
/**
 *
 * An ImageView which caches images to a local directory after they're initially loaded. After the images are cached,
 * they're subsequently loaded from the local directory, thereby reducing the overhead of refetching them from their
 * remote location.
 *
...
public class CachedImageView extends ImageView {
	 ...
	 *
	 * If the image is cached, the local file URL is returned. The superclass treats this the same as the actual url,
	 * but the image is loaded from the local cache rather than redownloading it
	 * @return 
	 */
	@Override
	...
	/**
	 * Returns the local file of the cached version of the image. The local file is named with the absolute value of the
	 * hashcode for the actual image url and a "png" or "jpg" file extension
	 *
	 * @return
	 */
