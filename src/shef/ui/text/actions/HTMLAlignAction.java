...
public class HTMLAlignAction extends HTMLTextEditAction {
	...
	public static final String ALIGNMENT_NAMES[]
			= {
				I18N.getMsg("shef.left"),
				I18N.getMsg("shef.center"),
				I18N.getMsg("shef.right"),
				I18N.getMsg("shef.justify")
			};

	private static final int[] MNEMS
			= {
				I18N.getMnemonic("shef.left"),
				I18N.getMnemonic("shef.center"),
				I18N.getMnemonic("shef.right"),
				I18N.getMnemonic("shef.justify")
			};
