...
/**
 * A collection of static convenience methods for working with HTML, HTMLDocuments, AttributeSets and Elements from HTML
 * documents.
 *
...
public class HTMLUtils {
	...
	/**
	 * Inserts a string of html into the {@link JEditorPane}'s {@link HTMLDocument} at the current caret position.
	 *
	 * @param html
	 * @param tag
	 * @param editor
	 ...
	 * <p>
	 * If there is no selection, the character attributes at caretPos - 1 are retuned. If there is a slection, the
	 * attributes at selectionEnd - 1 are returned
	 * </p>
	 *
	 * @param editor
	...
	/**
	 * Set's the font family at the {@link JEditorPane}'s current caret positon, or for the current selection (if there
	 * is one).
	 * <p>
	...
	/**
	 * Removes a CSS character attribute that has the specified value from the {@link JEditorPane}'s current caret
	 * position or selection.
	 * <p>
	 * The val parameter is a {@link String} even though the actual attribute value is not. This is because the actual
	 * attribute values are not public. Thus, this method checks the value via the toString() method</p>
	 *
	 * @param editor
	 * @param atr
	 * @param val
	 ...
	 *
	 * <p>
	 * Removes from the editor kit's input attribtues and/or document at the caret position. If there is a selction the
	 * attribute is removed from the selected text</p>
	 *
	 * @param editor
	 * @param atr
	 */
	...
	/**
	 * Converts an html tag attribute list to a {@link Map}. For example, the String 'href="http://blah.com"
	 * target="_self"' becomes name-value pairs:<br>
	...
	/**
	 * Convert a "#FFFFFF" hex string to a Color. If the color specification is bad, an attempt will be made to fix it
	 * up.
	 */
	 ...
	 *
	 * <p>
	 * JEditorpane can't handle empty xhtml containers like &lt;br /&gt; or &lt;img /&gt;, so this method replaces them
	 * without the "/" as in &lt;br&gt;</p>
	 *
	 * @param html
	...
	/**
	 * Helper method that prints out the contents of an {@link AttributeSet} to System.err for debugging
	 *
	 * @param attr
	 */
