...
public class SourceCodeEditor extends SyntaxTextPane
{
    ...
    public SourceCodeEditor()
    {
        ...
        SyntaxFactory.setSyntaxCatalog(getClass().getResource("/shef/resources/syntax.catalog.xml"));
        ...
        try
        {
            in = getClass().getResource("/shef/ui/text/syntax.properties").openStream();
            themes.load(in);
