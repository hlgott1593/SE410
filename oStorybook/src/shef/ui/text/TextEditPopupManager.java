...
public class TextEditPopupManager {
	...
	/**
	 * Registers a JTextComponent with the manager. Note that if you change the document of the JTextComponent, you
	 * should unregister it with method unregisterJTextComponent, and then re-register it with this method. e.g...
	 *
	 * <pre><code>
	...
	/**
	 * Registers a JTextComponent and UndoManager with the manager. This is useful if you wish to supply a custom
	 * UndoManager
	 *
	 * @param tc The JTextComponent to register
